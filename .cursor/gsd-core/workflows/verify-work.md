...
<template>
@C:/@code/spcs-transcripts/.cursor/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@C:/@code/spcs-transcripts/.cursor/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `C:/@code/spcs-transcripts/.cursor/gsd-core/workflows/transition.md`.
...
- Follow @C:/@code/spcs-transcripts/.cursor/gsd-core/workflows/diagnose-issues.md
