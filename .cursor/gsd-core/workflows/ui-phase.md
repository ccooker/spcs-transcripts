...
```markdown
Read C:/@code/spcs-transcripts/.cursor/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/@code/spcs-transcripts/.cursor/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/@code/spcs-transcripts/.cursor/agents/gsd-ui-checker.md for instructions.
