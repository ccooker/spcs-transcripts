...
```
Agent(
  prompt="Read C:/@code/spcs-transcripts/.cursor/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/@code/spcs-transcripts/.cursor/gsd-core/templates/VALIDATION.md`
