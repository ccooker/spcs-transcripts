...
<required_reading>
@C:/@code/spcs-transcripts/.cursor/gsd-core/references/user-story-template.md
@C:/@code/spcs-transcripts/.cursor/gsd-core/references/spidr-splitting.md
@C:/@code/spcs-transcripts/.cursor/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@C:/@code/spcs-transcripts/.cursor/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `conversational prompting` calls. Each is free-text. After all three, assemble into the canonical sentence per `@C:/@code/spcs-transcripts/.cursor/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@C:/@code/spcs-transcripts/.cursor/gsd-core/references/spidr-splitting.md`. Briefly:
