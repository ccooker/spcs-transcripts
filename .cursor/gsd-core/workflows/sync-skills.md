...
INSTALL_JS_GLOBAL="C:/@code/spcs-transcripts/.cursor/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/@code/spcs-transcripts/.cursor/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
