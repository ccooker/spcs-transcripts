...
- Usage: Reference from command with `@C:/@code/spcs-transcripts/.cursor/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to C:/@code/spcs-transcripts/.cursor/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to C:/@code/spcs-transcripts/.cursor/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
