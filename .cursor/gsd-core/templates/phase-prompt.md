...
<!-- For checkpoint task examples and patterns, see @C:/@code/spcs-transcripts/.cursor/gsd-core/references/checkpoints.md -->
...
See `C:/@code/spcs-transcripts/.cursor/gsd-core/references/tdd.md` for TDD plan structure.
...
See `C:/@code/spcs-transcripts/.cursor/gsd-core/templates/user-setup.md` for full schema and examples
...
See `C:/@code/spcs-transcripts/.cursor/gsd-core/workflows/verify-phase.md` for verification logic.
