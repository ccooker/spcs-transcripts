...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/@code/spcs-transcripts/.cursor/.gsd-surface.json`
(sibling to `C:/@code/spcs-transcripts/.cursor/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `C:/@code/spcs-transcripts/.cursor/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`C:/@code/spcs-transcripts/.cursor/skills`).
...
`C:/@code/spcs-transcripts/.cursor/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `C:/@code/spcs-transcripts/.cursor/.gsd-surface.json`).
...
<execution_context>
Surface state file: `C:/@code/spcs-transcripts/.cursor/.gsd-surface.json`
Install profile marker: `C:/@code/spcs-transcripts/.cursor/.gsd-profile`
Skill dirs: `C:/@code/spcs-transcripts/.cursor/skills/gsd-*/`
Engine module: `C:/@code/spcs-transcripts/.cursor/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `C:/@code/spcs-transcripts/.cursor/gsd-core/bin/lib/clusters.cjs`
</execution_context>
