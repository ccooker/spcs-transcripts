...
Use template from `C:/@code/spcs-transcripts/.cursor/gsd-core/templates/UI-SPEC.md`.
...
Read template: `C:/@code/spcs-transcripts/.cursor/gsd-core/templates/UI-SPEC.md`
