...
Reference full template: `C:/@code/spcs-transcripts/.cursor/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/@code/spcs-transcripts/.cursor/gsd-core/templates/state.md`.
