...
<required_reading>
@C:/@code/spcs-transcripts/.cursor/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@C:/@code/spcs-transcripts/.cursor/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/@code/spcs-transcripts/.cursor
                  → checks C:/@code/spcs-transcripts/.cursor/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/@code/spcs-transcripts/.cursor/gsd-core
                  → writes to C:/@code/spcs-transcripts/.cursor/gsd-core/hooks/
...
@C:/@code/spcs-transcripts/.cursor/gsd-core/references/thinking-models-debug.md
...
- Read @C:/@code/spcs-transcripts/.cursor/gsd-core/references/common-bug-patterns.md
